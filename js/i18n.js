...
const I18N = {
  'zh-CN': {
    ...
    heroTitle1: '手写转表格 · 转 Excel',
    heroTitle2: '不只是文字，连结构一起转',
    heroSub: '拍下手写笔记、账本、表单、单据，AI 识别文字同时保留表格、标题、清单结构 —— 直接导出 Excel / CSV / Word / Markdown，不确定处高亮确认。',
    quotaLabel: '今日剩余',
    quotaUnit: '次',
    dropTitle: '拖拽照片到这里，或点击上传',
    dropSub: '支持 JPG / PNG / PDF · 手写笔记、账本、表单、白板、扫描件均可',
    reset: '重新上传',
    recognize: '开始识别',
    scanning: '正在识别手写内容…',
    scanStep1: '读取图片',
    ...
    howTitle: '手写转表格、转文档，三步完成',
    step1Title: '拍照上传',
    step1Desc: '拍下手写笔记、账本、表单或白板，拖进页面即可，手机拍照也能用',
    step2Title: '识别文字与结构',
    step2Desc: '自动识别表格、标题层级、列表、待办，不只出文字，结构也保留',
    step3Title: '确认导出',
    step3Desc: '修改不确定处，一键导出 Excel / CSV / Word / Markdown',
    faqTitle: '常见问题',
    faq1Q: '手写能转成表格 / Excel 吗？和其他 OCR 有什么不同？',
    faq1A: '可以，这是我们的核心能力。普通手写识别/OCR 只输出纯文字，表格、账本、单据会乱掉；手写扫描通会识别表格结构并转成 Excel/CSV，识别标题层级、清单、待办转成结构化文档。手写笔记、账本、课表、单据都可以。',
  ...
  'en': {
    ...
    heroTitle1: 'Handwritten tables to Excel',
    heroTitle2: 'Not just text — structure too',
    heroSub: 'Photograph handwritten notes, ledgers, forms or receipts — AI extracts text while preserving tables, headings and lists. Export to Excel / CSV / Word / Markdown, uncertain items highlighted.',
    quotaLabel: 'Left today',
    quotaUnit: '',
    dropTitle: 'Drag a photo here, or click to upload',
    dropSub: 'JPG / PNG / PDF · Notes, ledgers, forms, whiteboards, scans',
    reset: 'Re-upload',
    recognize: 'Recognize',
    ...
    howTitle: 'Handwritten to tables & documents in 3 steps',
    step1Title: 'Upload a photo',
    step1Desc: 'Photograph notes, ledgers, forms or whiteboard and drag them in — mobile camera works too',
    step2Title: 'Extract text & structure',
    step2Desc: 'Detects tables, heading levels, lists and todos — structure is preserved, not just text',
    step3Title: 'Confirm & export',
    step3Desc: 'Edit uncertain items, export to Excel / CSV / Word / Markdown in one click',
    faqTitle: 'FAQ',
    faq1Q: 'Can handwriting become tables / Excel? How is this different from OCR?',
    faq1A: 'Yes — this is our core capability. Regular handwriting OCR only outputs plain text and destroys tables, ledgers and forms. HandWriteScan recognizes table structure and converts it to Excel/CSV, and detects headings, checklists and todos into structured documents. Notes, ledgers, schedules and forms all work.',
